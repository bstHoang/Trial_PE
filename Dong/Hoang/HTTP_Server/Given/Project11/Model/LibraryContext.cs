...
public partial class LibraryContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AuthorId).HasName("PK__Authors__70DAFC34965A39AB");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Books__3DE0C207DA03046F");
        ...
        {
            entity.HasKey(e => e.CopyId).HasName("PK__BookCopi__C26CCCC51DE0D234");
        ...
        {
            entity.HasKey(e => e.BorrowId).HasName("PK__BorrowHi__4295F83F0042CFAD");
        ...
        {
            entity.HasKey(e => e.BorrowerId).HasName("PK__Borrower__568EDB573596A2A5");
        ...
        {
            entity.HasKey(e => e.GenreId).HasName("PK__Genres__0385057E1EBD7D2F");
